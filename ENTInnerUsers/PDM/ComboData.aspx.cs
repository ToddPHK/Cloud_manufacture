...
public partial class ENTInnerUsers_PDM_ComboData : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (connectstr != "")
        {
            ...
            else if (Request["type"].Equals("TaskState"))
            {
                data = ToArrayString(connectstr, "select TaskStateID,TaskStateName from TaskState", "TaskStateID", "TaskStateName");
            }
            Response.Write(data);
            Response.End();
            Response.Clear();
