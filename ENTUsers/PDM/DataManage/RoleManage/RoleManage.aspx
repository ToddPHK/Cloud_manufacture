<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoleManage.aspx.cs" Inherits="PDM_DataManage_RoleManage_Default" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../../../js/DataManage/CodeOperaMethod.js"></script>
    <script type="text/javascript" src="../../../js/DataManage/RoleManage.js"></script>
