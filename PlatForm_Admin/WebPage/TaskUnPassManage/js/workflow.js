var mxClient = {
    ...
    TOOLTIP_SHADOWS: false,
    MENU_SHADOWS: false,
    isBrowserSupported: function () {
        return mxClient.IS_VML || this.IS_SVG;
    },
    link: function (rel, href, doc) {
        doc = doc || document;
        if (mxClient.IS_IE && !false) {
...
var mxUtils = {
    ...
    eval: function (expr) {
        ...
        if (expr.indexOf('function') >= 0
				&& (mxClient.IS_VML || false || mxClient.IS_SVG || false)) {
            try {
    ...
    makeDraggable: function (element, graph, funct, dragElement, dx, dy,
			autoscroll, scalePreview, highlightDropTargets) {
        dx = (dx != null) ? dx : 0;
        ...
        mxEvent.addListener(element, 'mousedown', function (evt) {
            if (graph.isEnabled() && !mxEvent.isConsumed(evt)) {
                ...
                var dragHandler = function (evt) {
                    ...
                    dropTarget = graph.getCellAt(pt.x, pt.y);
...
var mxEvent = {
    ...
    redirectMouseEvents: function (element, graph, cell, handle, transparent,
        ...
        var getState = function (evt) {
            ...
            var pt = mxUtils.convertPoint(graph.container, evt.clientX,
					evt.clientY);
            if (forceTransparent || (transparent && mxClient.IS_IE)) {
    ...
    addMouseWheelListener: function (funct) {
        if (funct != null) {
            var wheelHandler = function (evt) {
                ...
                var delta = 0;
                if (mxClient.IS_SVG && !false && !false) {
                    delta = -evt.detail / 2;
                } else {
    ...
    mxPopupMenu.prototype.showSubmenu = function (parent, row) {
        if (row.div != null) {
            ...
            var right = (b.scrollLeft || d.scrollLeft)
					+ (b.clientWidth || d.clientWidth);
            if (left + width > right) {
                row.div.style.left = (parent.div.offsetLeft - width + ((mxClient.IS_IE)
						? 6
						: -6))
						+ 'px';
            }
...

{
    ...
    mxShape.prototype.init = function (container) {
        ...
        if (this.insertGradientNode != null) {
            ...
            if (gradient != null) {
                this.innerNode.setAttribute('fill', 'url(#' + id + ')');
            }
            if (this.insertGradientNode != null) {
...

{
    function mxText(value, bounds, align, valign, color, family, size,
			...
			isAbsolute, isWrapping, isClipping) {
        this.value = value;
        this.bounds = bounds;
    ...
    mxText.prototype.create = function (container) {
        var node = null;
        if (this.dialect == mxConstants.DIALECT_SVG
				&& (!mxClient.IS_SVG || !this.ENABLE_FOREIGNOBJECT)) {
            node = this.createSvg();
        } else if (this.dialect == mxConstants.DIALECT_STRICTHTML
				|| this.dialect == mxConstants.DIALECT_PREFERHTML
        ...
        if (this.value != null) {
            ...
            if (this.isAbsolute
                ...
                if (mxUtils.isVml(this.node)) {
                    ...
                    if (mxUtils.isVml(this.node.parentNode) || mxClient.IS_VML) {
            ...
            if (!mxUtils.isNode(this.value)) {
                ...
                if (mxClient.IS_VML && this.isStyleSet(mxConstants.FONT_SHADOW)) {
...

{
    ...
    //----------------我的自定义属性-----开始----------------------
    mxCell.prototype.mystate = null;
    mxCell.prototype.task = null;
    mxCell.prototype.taskID = null;
    ...
    mxCell.prototype.mxTransient = ['mystate', 'chargeperson', 'planstartdate', 'planenddate', 'startdate', 'enddate', 'task', 'id', 'value', 'parent', 'source',
    ...
    /*
    mxCell.prototype.setPlanStartDate = function (planstartdate) {
        this.planstartdate = planstartdate;
    };
    mxCell.prototype.getPlanStartDate = function () {
        return this.planstartdate;
    };
    mxCell.prototype.getPlanEndDate = function () {
        return this.planenddate;
    };
    mxCell.prototype.setPlanEndDate = function (planenddate) {
        this.planenddate = planenddate;
    };
    mxCell.prototype.getStartDate = function () {
        return this.startdate;
    };
    mxCell.prototype.setStartDate = function (startdate) {
        this.startdate = startdate;
    };
    mxCell.prototype.getEndDate = function () {
        return this.enddate;
    };
    mxCell.prototype.setEndDate = function (enddate) {
    ...
    mxCell.prototype.getAttribute = function (name, defaultValue) {
        ...
        //return  userObject.getAttribute(name);
    };
...

{
    ...
    mxCellRenderer.prototype.checkStyleChanged = false;
    ...
    mxCellRenderer.prototype.getLabelValue = function (state) {
        ...
        if (!graph.isHtmlLabel(state.cell)
				&& (value != null && !mxUtils.isNode(value)) && mxClient.IS_IE) {
    ...
    mxCellRenderer.prototype.redrawControl = function (state) {
        if (state.control != null) {
            ...
            var bounds = (state.view.graph.getModel().isEdge(state.cell))
    ...
    mxCellRenderer.prototype.redraw = function (state) {
        if (state.shape != null) {
            ...
            if (this.checkStyleChanged) {
                ...
                if (!mxUtils.equalEntries(style, state.style)) {
                    state.style = style;
                    state.shape.apply(state);
                    reconfigure = true;
                }
...
var mxEdgeStyle = {
    ...
    Loop: function (state, source, target, points, result) {
        ...
        var s = view.scale;
        if (pt != null) {
            pt = new mxPoint(s * (view.translate.x + pt.x + state.origin.x), s
							* (view.translate.y + pt.y + state.origin.y));
        ...
        if (source != null && target != null) {
            if (pt != null) {
                ...
                var bottom = Math.max(source.y + source.height, target.y
								+ target.height);
                var view = state.view;
                pt = new mxPoint(view.scale
								* (view.translate.x + pt.x + state.origin.x),
        ...
        if (container != null) {
            ...
            mxEvent.addListener(container, 'mousedown', function (evt) {
                ...
                if (self.isContainerEvent(evt)
						&& ((!mxClient.IS_IE && !false && !false && !false) || !self
								.isScrollEvent(evt))) {
                    graph.fireMouseEvent(mxEvent.MOUSE_DOWN,
...

{
    function mxGraph(container, model, renderHint) {
        ...
        } else if (renderHint == mxConstants.RENDERING_HINT_EXACT
				&& mxClient.IS_VML) {
                ...
                if (dy < border) {
                    ...
                    if (old == c.scrollTop && extend) {
                        if (this.dialect == mxConstants.DIALECT_SVG) {
                            ...
                            var canvas = this.view.getDrawPane();
                            var height = parseInt(canvas.style.height) + border
									- dy;
    ...
    mxGraph.prototype.moveCells = function (cells, dx, dy, clone, target, evt) {
        if (cells != null && (dx != 0 || dy != 0 || clone || target != null)) {
            ...
            this.fireEvent(mxEvent.MOVE_CELLS, new mxEventObject([cells, dx,
							dy, clone, target, evt]));
        }
        return cells;
    };
        ...
        if (cells != null && (dx != 0 || dy != 0)) {
            ...
            try {
                ...
                for (var i = 0; i < cells.length; i++) {
                    ...
                    if (geo != null) {
                        geo = geo.translate(dx, dy);
                        if (geo.relative && !this.model.isEdge(cells[i])) {
                            if (geo.offset == null) {
    ...
    mxGraph.prototype.zoomIn = function () {
        ...
        if (this.keepSelectionVisibleOnZoom && state != null) {
            var rect = new mxRectangle(state.x * this.zoomFactor, state.y
							* this.zoomFactor, state.width * this.zoomFactor,
            ...
            this.view.scaleAndTranslate(scale, this.view.translate.x - w * f,
    ...
    mxGraph.prototype.fireMouseEvent = function (evtName, me, source) {
        ...
        if (!mxClient.IS_IE && evtName == mxEvent.MOUSE_DOWN
...

{
    ...
    mxMultiplicity.prototype.check = function (graph, edge, source, target,
        ...
        if ((sourceValue != null && targetValue != null)
				&& ((this.source && mxUtils.isNode(sourceValue, this.type,
						this.attr, this.value)) || (!this.source && mxUtils
						.isNode(targetValue, this.type, this.attr, this.value)))) {
...

{
    ...
    mxConnectionHandler.prototype.createIcons = function (state) {
        ...
        if (image != null && state != null) {
            ...
            icon.node.style.cursor = (mxClient.IS_IE)
					? 'all-scroll'
					: 'pointer';
        ...
        if (!me.isConsumed() && this.isEnabled() && this.graph.isEnabled()
            ...
            if (this.previous != null && this.start != null) {
                ...
                if (state != null && this.error == null) {
                    ...
                    state.shape.node.style.cursor = (mxClient.IS_IE)
							? 'all-scroll'
							: 'default';
...
mxCodecRegistry.register(function () {
    ...
    codec.afterEncode = function (enc, obj, node) {
        if (obj.value != null
            ...
            var tmp = node;
            node = (mxClient.IS_IE) ? obj.value.cloneNode(true) : enc.document
