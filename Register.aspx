...
<body>
        ...
        <table style="border: medium solid #FFFFFF; margin-left: 20%;" align="center">
            <tr>
                ...
                <td align="left" colspan="2">
                    ...
                    <asp:RequiredFieldValidator runat="server" ControlToValidate="FileUpload1" ForeColor="#CC0000"
                        ErrorMessage="*必须上传有关公司的合法性文件和平台合同">
            ...
            <tr>
                ...
                <td class="style1">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator6" ControlToValidate="Entwebsite"
                        runat="server" ForeColor="#CC0000" ErrorMessage="格式不正确" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&amp;=]*)?"></asp:RegularExpressionValidator>
                </td>
            </tr>
            <tr>
                <th align="right">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            <center>
                <div style="border: medium solid #FFFFFF; width: 70%; height: 200px;">
                    是否把本企业的项目任务数据库放在本地服务器：
