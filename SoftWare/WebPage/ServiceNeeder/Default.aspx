...
<head runat="server">
    ...
    <script type="text/javascript" src="../../js/ServiceNeeder/SoftWareTablePanel.js"></script>
    <script type="text/javascript" src="../../js/ServiceNeeder/softWareSearch.js"></script>
