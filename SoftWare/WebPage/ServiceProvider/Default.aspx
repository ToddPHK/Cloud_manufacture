...
<head runat="server">
    ...
    <script type="text/javascript" src="../../js/ServiceProvider/SoftWareTablePanel.js"></script>
    <script type="text/javascript" src="../../js/ServiceProvider/softWareSearch.js"></script>
