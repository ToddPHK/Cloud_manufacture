...
//------------------------------------------------
var MyApplyUserName_Search = new Ext.form.TextField({//软件语言
    fieldLabel: "申请企业",
    regex: /^[^\\'‘’]+$/,
    regexText: "不能包含单引号",
    width: 140
...
function SoftWareSearch() {
    if (SearchPanel.form.isValid())//判断是否通过客户端验证
    {
        ...
        SoftWareTabletore.baseParams.MyApplyEntUserName = MyApplyUserName_Search.getRawValue();
